return {
	Weapons = {
        ...
        ['WEAPON_PEPPERSPRAY'] = {
			label = 'Bombe Lacrymogène',
			weight = 2000,
			durability = 0.05
		},
        ['WEAPON_ANTIDOTE'] = {
			label = 'Antidote Lacrymogène',
			weight = 2000,
			durability = 0.05
		},
        ['WEAPON_BEANBAG'] = {
	...
	Ammo = {
        ...
        ['lmgammo'] = {
			label = 'Mun. Mitrailleuse',
			weight = 11,
		},

        ['paintballammo'] = {
			label = 'Bille de Peinture',
			weight = 30,
		},
    ...
    Clips = {
		...
		['extendedcombatpistolclip'] = {
					label = 'Ch. Am. Pistolet de Combat',
					ammoname = 'pistolammo',
					ammocount = 16,
					weight = 280,
                    buttons = {
		...
		['extendedapppistolclip'] = {
					label = 'Ch. Am. Pistolet Perforant',
					ammoname = 'pistolammo',
					ammocount = 36,
					weight = 280,
                    buttons = {
		...
		['extendedpistol50clip'] = {
					label = 'Ch. Am. Pistolet Cal .50',
					ammoname = 'pistolammo',
					ammocount = 12,
					weight = 280,
                    buttons = {
		...
		['extendedsnspistolclip'] = {
					label = 'Ch. Am. Pistolet SNS',
					ammoname = 'pistolammo',
					ammocount = 12,
					weight = 280,
                    buttons = {
		...
		['extendedheavypistolclip'] = {
					label = 'Ch. Am. Pistolet Lourd',
					ammoname = 'pistolammo',
					ammocount = 36,
					weight = 280,
                    buttons = {
		...
		['extendedvintagepistolclip'] = {
					label = 'Ch. Am. Pistolet Vintage',
					ammoname = 'pistolammo',
					ammocount = 14,
					weight = 280,
                    buttons = {
		...
		['extendedgusenbergclip'] = {
					label = 'Ch. Am. Gusenberg',
					ammoname = 'smgammo',
					ammocount = 50,
					weight = 280,
                    buttons = {
		...
		['extendedcombatmgclip'] = {
					label = 'Ch. Am. Mitrailleuse de Combat',
					ammoname = 'lmgammo',
					ammocount = 200,
					weight = 280,
                    buttons = {
		...
		['extendedheavysniperclip'] = {
					label = 'Ch. Am. Sniper Lourd',
					ammoname = 'sniperammo',
					ammocount = 8,
					weight = 280,
                    buttons = {
		...
		['extendedmarksmansniperclip'] = {
					label = 'Ch. Am. Sniper Marksman',
					ammoname = 'sniperammo',
					ammocount = 16,
					weight = 280,
                    buttons = {
