return {
	...
	--[[Ammunation = {
		...
		inventory = {
            ...
            { name = 'WEAPON_CROWBAR', price = 3500 },
            { name = 'WEAPON_WRENCH', price = 3500 },
            { name = 'WEAPON_KNUCKLE', price = 4000 },
            { name = 'WEAPON_KATANA', price = 4000 },
    ...
    MCEventShop = {
		...
		--[[blip = {
			...
			{ name = 'poster', price = 0, grade = 1},
			{ name = 'posterremover', price = 0, grade = 1},
		}, locations = {
	...
	PoliceArmoury = {
		...
		--[[blip = {
            ...
            --{name = 'shotgunammo', price = 0, grade = 3},
			...
			{name = 'bulletproof', grade = 1, metadata = {bulletproofvesttype = 51, label = "Gilet Gang Unit", image = "bulletproof_gangunit" }, price = 0},
	...
	Illegal_BlackMarket = {
		name = 'Black Market',
		inventory = {
            { name = 'spray', price = 2000, currency = 'black_money' },
            { name = 'hood', price = 2500, currency = 'black_money' },
            { name = 'binoculars', price = 5000, currency = 'black_money' },
			{ name = 'lockpick', price = 5000, currency = 'black_money' },
			{ name = 'drill', price = 9000, currency = 'black_money' },
			{ name = 'parachute', price = 10000, currency = 'black_money' },
            { name = 'WEAPON_KNIFE', price = 12000, currency = 'black_money' },
            { name = 'WEAPON_SWITCHBLADE', price = 12000, currency = 'black_money' },
	...
	--[[Illegal_Fisherman = {
		...
		inventory = {
			...
			vector3(-1157.376, -562.1689, 35.77909)
		}, targets = {
    ...
    Lockpick2Shop = {
		...
		--[[blip = {
			...
			vec3(2191.674805, 3495.547363, -150.945801),
		}, targets = {
